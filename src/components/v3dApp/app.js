...
function prepareExternalInterface(app) {
  ...
  // app.ExternalInterface.getVideo = async function () {
  //   return await "https://res.cloudinary.com/yurand/video/upload/v1603732167/video_despiece_axtqye.mp4";
  // };
  ...
  app.ExternalInterface.GetURLJson = function () {
    //console.log("sdasdasdasdasdasdasdasdasda"+urlFacebook);
    return urlFacebook;
  };
...
function getUrlFacebook(url) {
  urlFacebook = url;
  //console.log("sdasdasdasdasdasdasdasdasda"+url[0]);
}
...
function setVarShowRoom(f) {
  varShowRoom=f;
}
function getVarShowRoom() {
  return varShowRoom;
}
function getVarID_ShowRoom() {
  return id_Showroom;
}
...
function runCode(app) {
  ...
  // app.BoxGeometry(1,1,1)
  // const geometry = new v3dModule.BoxBufferGeometry(200, 200, 200);
  //       const material = new v3dModule.MeshBasicMaterial({ map: texture });
  //       mesh = new v3dModule.Mesh(geometry, material);
  //       app.scene.add(mesh);
  // const geometry = new v3d.BoxBufferGeometry(50, 50, 50);
  // const material = new v3d.MeshStandardMaterial({ color: 0xffffff });
